            ...
            <form action="" method="POST">
              ...
              <div>
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="text" id="kode_kelas" name="kode_kelas" required="required" class="form-control ">
                </div>
              </div>
              <div>
              ...
              <div>
                ...
                <div class="col-md-6 col-sm-6 ">
                  <input type="number" id="jmlh_mahasiswa" name="jmlh_mahasiswa" required="required" class="form-control ">
                </div>
              </div>
              <div class="mt-4">
                <div class="col-md-6 col-sm-6">
